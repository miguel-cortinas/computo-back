...
-- insertar datos de las regiones
...
-- Insertar datos en la nueva tabla solo para las regiones 'A' y 'B' | 'C' y 'D' 
INSERT INTO NUEVA_TABLA (CUSTOMER_ID, CUST_FIRST_NAME, CUST_LAST_NAME, CREDIT_LIMIT, CUST_EMAIL, INCOME_LEVEL, REGION)
...
-- Cambiar el nombre de la nueva tabla para que sea igual al nombre original
ALTER TABLE NUEVA_TABLA RENAME TO CUSTOMERS;


-- insertar resto de datos
